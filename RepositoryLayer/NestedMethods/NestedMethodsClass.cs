...
namespace RepositoryLayer.NestedMethods
{
    public class NestedMethodsClass
    {
        ...
        //mobile number logic
        public static bool IsValidMobileNumber(long mobileNumber)
        {
            string mobileNumberString = mobileNumber.ToString();
            string pattern = @"^\d{10}$";
            return Regex.IsMatch(mobileNumberString, pattern);
        }
        //SendMail Logic
